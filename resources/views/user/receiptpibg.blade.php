...
<head>
    ...
    <title>{{$fee_payment_invoiceno}}</title>
</head>
<style>
    body {
...
<body>
    ...
    <table cellspacing="0" class="title">
        <tr>
            <th>Resit # {{$fee_payment_invoiceno}}</th>
            <th style="text-align: right">{{$fee_payment_date}}</th>
        </tr>
    </table>
    <table cellspacing="0" class="summary">
        <thead>
            <tr>
                <td colspan="2">Butiran Pembayar</td>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td width="150">Nama</td>
                <td style="text-align: right;">{{$payer_name}}</td>
            </tr>
            <tr>
                <td>E-mel</td>
                <td style="text-align: right;">{{$payer_email}}</td>
            </tr>
            <tr>
                <td>No. Telefon</td>
                <td style="text-align: right;">{{$payer_notel}}</td>
            </tr>
        </tbody>
    </table>
    <table cellspacing="0" class="summary">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align: right;">{{$fee_payment_date}}</td>
            </tr>
            <tr>
                <td>Jumlah Bayaran</td>
                <td style="text-align: right;"><b>RM {{$fee_payment_amount}}</b></td>
            </tr>
        </tbody>
    </table>
    <div class="footer">
        <p>Terima kasih atas pembayaran yuran!</p>
    </div>
</body>
</html>
