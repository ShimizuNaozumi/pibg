<style>
  .nav-link.active {
    background-color: rgb(116, 116, 158);
  }
</style>
  <!-- Sidebar -->
    ...
    <div class="container-fluid">
          ...
          <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
            ...
            <div class="d-none d-xl-block ps-2">
              ...
              <div class="mt-1 small text-secondary">
                ...
                Pentadbir
                @elseif($acc->admin_category == 'teacher')
                Guru
                @elseif($acc->admin_category == 'treasurer')
                Bendahari
                @endif
              </div>
            </div>
      ...
      <div class="collapse navbar-collapse" id="sidebar-menu">
        <ul class="navbar-nav pt-lg-3">
          ...
          <li class="nav-item mb-3">
            <a class="nav-link {{request()->routeIs('classes') || request()->routeIs('students') || request()->routeIs('show_student') ? 'active' : ''}}" href="{{route('classes')}}" >
              <span class="nav-link-icon d-md-none d-lg-inline-block">
          ...
          <li class="nav-item mb-3">
            <a class="nav-link {{request()->routeIs('show_donation') ||request()->routeIs('donation') ? 'active' : ''}}" href="{{route('donation')}}">
              <span class="nav-link-icon d-md-none d-lg-inline-block">
          ...
          <li class="nav-item mb-3">
            <a class="nav-link {{request()->routeIs('fee') ? 'active' : ''}}" href="{{route('fee')}}">
              <span class="nav-link-icon d-md-none d-lg-inline-block">
          ...
          @if($acc->admin_category != 'teacher')
          <li class="nav-link fw-bold text-white">
            LAPORAN
          </li>
          <li class="nav-item dropdown mb-3">
            <a class="nav-link dropdown-toggle {{request()->routeIs('donation_report') ? 'active' : ''}}" data-bs-toggle="dropdown" data-bs-auto-close="outside" role="button" aria-expanded="false"  >
              <span class="nav-link-icon d-md-none d-lg-inline-block">
          ...
          <li class="nav-item mb-3">
            <a class="nav-link {{request()->routeIs('edit_fund') || request()->routeIs('read_fund') || request()->routeIs('fund') || request()->routeIs('add_fund') ? 'active' : '' }}" href="{{route('fund')}}">
              <span class="nav-link-icon d-md-none d-lg-inline-block">
          ...
          @if($acc->admin_category == 'superadmin')
          <li class="nav-item mb-3">
            <a class="nav-link {{request()->routeIs('read_fee') || request()->routeIs('fee_session') ? 'active' : ''}}" href="{{route('fee_session')}}">
              <span class="nav-link-icon d-md-none d-lg-inline-block">
          ...
          @endif
          <li class="nav-item dropdown mb-3">
            <a class="nav-link dropdown-toggle {{request()->routeIs('admins') || request()->routeIs('users') ? 'active' : ''}}" data-bs-toggle="dropdown" data-bs-auto-close="outside" role="button" aria-expanded="false"  >
              <span class="nav-link-icon d-md-none d-lg-inline-block">
